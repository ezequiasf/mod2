...
CREATE TABLE APP_RECEITAS.RECEITA(
    ...
    CONSTRAINT FK_RECEITA_USUARIO_CID_USUARIO FOREIGN KEY (ID_USUARIO) REFERENCES USUARIO (ID_USUARIO)
);
...
CREATE TABLE APP_RECEITAS.COMENTARIO (
    ...
    CONSTRAINT FK_COMENT_RECEITA_CID_RECEITA FOREIGN KEY (ID_RECEITA) REFERENCES RECEITA (ID_RECEITA),
    CONSTRAINT FK_COMENT_USUARIO_CID_USUARIO FOREIGN KEY (ID_USUCOMENT) REFERENCES USUARIO (ID_USUARIO)
);
CREATE TABLE APP_RECEITAS.NOTA (
    ...
    CONSTRAINT FK_NOTA_RECEITA_CID_RECEITA FOREIGN KEY (ID_RECEITA) REFERENCES RECEITA (ID_RECEITA),
    CONSTRAINT FK_NOTA_USUARIO_CID_USUARIO FOREIGN KEY (ID_USUNOTA) REFERENCES USUARIO (ID_USUARIO)
);
